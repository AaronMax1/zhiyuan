...
if [[ ! -f "$ROOT_DIR/data-pipeline/output/unified_admission.db" || ! -f "$ROOT_DIR/data-pipeline/output/score_segments.db" || ! -f "$ROOT_DIR/data-pipeline/output/batch_control_lines.db" ]]; then
